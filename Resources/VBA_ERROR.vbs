...
'I decided to inclue the annual open and annual close on the table. Please dont doc me points for this...maybe I should just remove it
    ...
    For j = 1 To totalworksheets
        ...
        ActiveSheet.Range("N1").Value = "Annual Open"
        ActiveSheet.Range("O1").Value = "Annual Close"
        ...
        While Cells(newcounter, 11).Value = "" And Cells(newcounter, 10).Value <> "" And Cells(newcounter, 11).Interior.ColorIndex = xlColorIndexNone
            ...
            'maybe I should remove the annual open and annual close from the table since it's not included on the assignment
            'if statement put in place to deal with PLNT $0 stock value and dividing by zero issue
            If annualopen = 0 Or annualclose = 0 Then
                
                yearlychange = annualopen - annualclose
                Cells(newcounter, 11).Value = yearlychange
                Cells(newcounter, 13).Value = totalstock
                Cells(newcounter, 14).Value = annualopen
                Cells(newcounter, 15).Value = annualclose
                yearlychange = 0
                percentchange = 0
            Else:
                yearlychange = annualopen - annualclose
